...
function _getUploadPath($photo) {
    return APPPATH . _getRelativeUploadsPath($photo);
}

function _getSquareUploadPath($photo) {
    return APPPATH . _getRelativeSquareUploadsPath($photo);
}
...
function _getDressupPath($photo) {
    return APPPATH . _getRelativeDressupsPath($photo);
}

function _getSquareDressupPath($photo) {
    return APPPATH . _getRelativeSquareDressupsPath($photo);
}
