...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <header id="top">
            <ul>
                <li><a href="/"><img src="/images/home1.png" class="imgTrans" data-hover="home1.png" data-nhover="home2.png"></a></li>
            ...
            <ul class="tabs">
                <li class="hasmore"><a href="#"><span><img src="/images/menu/else.png"></span></a>
                    <ul class="dropdown">	
                        ...
                        <li class="last"><a href="/wall">My Wall</a></li>
                    </ul>
                </li>
