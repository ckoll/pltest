            ...
            <table width="600" align="center" cellpadding="0" cellspacing="0" style="font-size:11px;">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" style="padding:5px">
                        <?=$data['username']?> has requested to be your friend at Perfect-Look.org.<br>
                        Please log into your account and go to "My Friends" section to confirm or deny the request.
                    </td>
                </tr>
                <tr>
