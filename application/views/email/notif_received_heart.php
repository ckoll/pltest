            ...
            <table width="600" align="center" cellpadding="0" cellspacing="0" style="font-size:11px;">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" style="padding:5px">
                        ...
                        <h2 style="color:#FF66CC;">You have received a heart on your photo.</h2>
                                ...
                                <td>
                                    <p>
                                        <span style="font-weight: bold">
                                            <a style="color:#d08ab1" href="<?= base_url() ?><?=$user['username']?>"><?=$user['username']?></a>
                                        </span>
                                    </p>
                                    <p>
                                        Please
                                        <a style="color:#d08ab1" href="<?= base_url() ?>signin">login</a>
                                        to your account to <a style="color:#d08ab1" href="<?= base_url() ?><?=$photo['username']?>/photo/<?=$photo['id'] . $photo['rand_num']?>">check it</a>.
