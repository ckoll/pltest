...
<div id="content">
    ...
    <div class="bg">
        <form action="" method="post">
            ...
            <input type="hidden" name="upload_x2"
                   value="<?=((empty($thumb_xy)) ? (($crop_img_height < $crop_img_width) ? $crop_img_height : $crop_img_width) : $thumb_xy['x2'])?>"/>
            <input type="hidden" name="upload_y2"
                   value="<?=((empty($thumb_xy)) ? (($crop_img_height < $crop_img_width) ? $crop_img_height : $crop_img_width) : $thumb_xy['y2'])?>"/>
            <table>
                <? for ($x = 0; $x < 5; $x++) { ?>
                <tr>
                    <td>
                        <select name="pos[]">
                            ...
                            <option value="top" <? if ($tags[$x]['position'] == 'top') echo'selected="selected"' ?>>
                                top
                            </option>
                            <option value="shoes" <? if ($tags[$x]['position'] == 'shoes') echo'selected="selected"' ?>>
                                shoes
                            </option>
                            <option value="accessories" <? if ($tags[$x]['position'] == 'accessories') echo'selected="selected"' ?>>
                                accessories
                            </option>
                            <option value="bottoms" <? if ($tags[$x]['position'] == 'bottoms') echo'selected="selected"' ?>>
                                bottoms
                            </option>
                        </select>
                    </td>
                    ...
                    <td><span class="left" style="margin-right: 5px;">by</span>
                        <select data-placeholder="Select members" style="width:220px;" name="brand[]"
                                class="chzn-select">
