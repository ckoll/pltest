...
<div id="content" style="width: 1000px">
    ...
    <div class="bg">
        ...
        <div style="margin-bottom: 6px;">
            ...
            <br>
            Your doll:
            <span><?= (!empty($this->user['doll_name'])) ? $this->user['doll_name'] : 'Not set yet ' ?></span> <a
                id="new_doll_name">edit dollname</a>
            <span class="hide dollname_form">
                <input type="text" name="doll_name" maxlength="30"
                       value="<? if (!empty($this->user['doll_name'])) echo $this->user['doll_name']; ?>">
        ...
        <h2>Item you are using now &nbsp;&nbsp;<a href="/inventory" target="_blank">Item Inventory</a></h2>
    ...
    <div class="modal">
        <div class="step1">
            ...
            <select name="saving" class="hide">
                ...
                <option value="<?= $curr_dresup; ?>" <? if (!empty($_GET['edit'])) echo'selected="selected"'; ?>>Save
                    current look
                </option>
            </select>
            ...
            <div class="day_look">
                ...
                <input type="radio" name="daylook"
                       value="1" <? if (empty($today_dressup_finded)) echo'checked="checked"'?>> yes &nbsp;
                <input type="radio" name="daylook"
                       value="2" <? if (!empty($today_dressup_finded)) echo'checked="checked"'?>> no<br><br>
            </div>
        ...
        <div class="step2 hide">
            ...
            <p class="left">
                ...
                <input type="hidden" name="base_dressup_url"
                       value="http://<?= $_SERVER['SERVER_NAME'] ?>/<?= $this->user['username'] ?>/dressup/">
            </p>
            <br class="clear">
...
<div id="outfit_modal" class="hide" title="Save Outfit">
    <div class="modal center">
        <div class="step_outfit1">
            <p>You can quick-save an outfit for easy<br> dressup later convenient for saving <br>frequently worn item
                groups or looks.</p><br><br>
...
<div id="share_email_modal" class="hide" title="Share Dressup">
    <div class="modal center">
        <div class="first">
            ...
            <small class="left">*Separate email addresses with a comma</small>
            <br><br>
