...
<div id="content">
    ...
    <div class="bg">
        ...
        <div id="tabs">
            <ul>
                <li><a href="#tabs1">By username</a></li>
                <li><a href="#tabs2">From your contacts</a></li>
            </ul>
            <div id="tabs1">
                ...
                <div class="left">
                    <form action="" method="get" style="margin: 0">
                        <input type="text" name="username" value="<?= @$this->input->post('username') ?>"> <input
                            type="submit" name="search_username" value="Search">
                    </form>
                </div>
                <br class="clear">
                <?
            ...
            <div id="tabs2">
                ...
                <div class="left">
                    ...
                    <br clear="all">
                    <a href="/find_friends/?fb=1"
                       class="button contacts_big <? if ($system == 'facebook') echo'checked' ?>"
                       data-system="facebook">Find on Facebook</a><br clear="all">
                    <a href="/find_friends/?tw=1"
                       class="button contacts_big <? if ($system == 'twitter') echo'checked' ?>" data-system="twitter">Find
                        on Twitter</a>
                </div>
                <br class="clear">
                ...
                <form action="/invite_friends" method="post">
                    ...
                    if (!empty($mail_contacts)) {
                            ...
                            foreach ($mail_contacts as $key => $val) {
                                ...
                                <tr <? if ($x % 2 == 0) echo'class="odd"' ?>>
                                    ...
                                    <td width="100">
                                        ...
                                        if (in_array($key, $finded_emails)) {
                                            ?>
                                            <a href="/<?= (empty($finded[$key]['username'])) ? 'id' . $finded[$key]['id'] : $finded[$key]['username']; ?>"
                        ...
                        <table width="100%" class="friends_table">
                                ...
                                <tr <? if ($x % 2 == 0) echo'class="odd"' ?>>
                                    <td width="20"><?
                                        if (!in_array($val['id'], $finded_ids)) {
                                            ?><input type="checkbox" name="invite[<?= $val['id'] ?>]"
                                                     value="<?= $val['name'] ?>"><?
                                        } else {
                                            ?><input type="checkbox" disabled="disabled"><?
                                        }
                                    ...
                                    <td width="100">
                                        <?
                                        if (in_array($val['id'], $finded_ids)) {
                                            ?><a href="/id<?= $finded[$val['id']]['id'] ?>" target="_blank">view
                                                profile</a><?
                                        } else {
                                            ?><em class="red">not registered</em><?
                                        }
                            ...
                            ?></table>
                        <input type="submit" <? if ($system == 'facebook') echo'name="send_invite"' ?>
                               value="Invite Friends >" class="button contacts_medium right">
                        <br class="clear">
                        <?
                    } elseif ($system && empty($err)) {
                        ?>
                        <span class="err">*You have no <?= ($system == 'facebook' || $system == 'twitter') ? 'friends' : 'contacts'; ?>
                            on <?= $system ?></span><?
                    }
                    ?>
