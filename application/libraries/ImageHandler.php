...
class ImageHandler {
    ...
    public function resize($toWidth, $toHeight, $proportional = true) {
        ...
        imagecopyresampled($newImage, $this->image, 0, 0, $this->pos_x, $this->pos_y, $newWidth, $newHeight, $this->width, $this->height);
    ...
    public function save($file = false, $toFormat = false, $jpegQuality = 92, $touch = false) {
        if (empty($file)) {
            $file = $this->fileName;
        }
